...
namespace API_X.Controllers
{
    ...
    [ApiController]
    public class ConsultaFuncionario : ControllerBase
    {
        [HttpGet]
        public string ConsultarFuncionario(string p_Nome)
        {
            ...
            Conexao.Open();
            string wQuery = $"select * From Funcionario where Nome like '%{p_Nome}%'";
