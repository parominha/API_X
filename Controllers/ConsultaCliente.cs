...
namespace API_X.Controllers
{
    ...
    [ApiController]
    public class ConsultaCliente : ControllerBase
    {
        [HttpGet]
        public string ConsultarCliente(string p_Nome)
        {
            ...
            Conexao.Open();
            string wQuery = $"select * From Cliente where RazaoSocial like '%{p_Nome}%'";
